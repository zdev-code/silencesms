...
public final class FingerprintProtos extends com.google.protobuf.GeneratedFile {
    ...
    public static final class Builder extends
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage
          ...
          internalGetLocalFingerprintFieldBuilder();
          internalGetRemoteFingerprintFieldBuilder();
        }
      }
      @java.lang.Override
      public Builder clear() {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 18: {
                input.readMessage(
                    internalGetLocalFingerprintFieldBuilder().getBuilder(),
                    extensionRegistry);
              ...
              case 26: {
                input.readMessage(
                    internalGetRemoteFingerprintFieldBuilder().getBuilder(),
                    extensionRegistry);
      ...
      public org.whispersystems.libsignal.fingerprint.FingerprintProtos.LogicalFingerprint.Builder getLocalFingerprintBuilder() {
        bitField0_ |= 0x00000002;
        onChanged();
        return internalGetLocalFingerprintFieldBuilder().getBuilder();
      }
      /**
       * <code>optional .textsecure.LogicalFingerprint localFingerprint = 2;</code>
       */
      ...
      public org.whispersystems.libsignal.fingerprint.FingerprintProtos.LogicalFingerprint.Builder getRemoteFingerprintBuilder() {
        bitField0_ |= 0x00000004;
        onChanged();
        return internalGetRemoteFingerprintFieldBuilder().getBuilder();
      }
      /**
       * <code>optional .textsecure.LogicalFingerprint remoteFingerprint = 3;</code>
       */
