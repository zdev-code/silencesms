...
public final class ConversationScreenStateStore {
  ...
  @Inject
  public ConversationScreenStateStore(SavedStateHandle handle) {
    this.handle = handle;
  }

  public boolean hasConversation() { return handle.contains(KEY_RECIPIENT_IDS); }
  ...
  public int getDistributionType(int defaultValue) {
  ...
  public void save(long[] recipientIds, long threadId, int distributionType, boolean archived) {
