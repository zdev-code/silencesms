...
public class VendoredSignalProtocolStore implements SignalProtocolStore {
  ...
  public VendoredSignalProtocolStore(Context context, MasterSecret masterSecret, int subscriptionId) {
    this.preKeyStore       = new VendoredPreKeyStore(context, masterSecret, subscriptionId);
    this.signedPreKeyStore = new VendoredPreKeyStore(context, masterSecret, subscriptionId);
    this.identityKeyStore  = new VendoredIdentityKeyStore(context, masterSecret, subscriptionId);
    this.sessionStore      = new VendoredSessionStore(context, masterSecret, subscriptionId);
